...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    do {
                        System.out.print("\n            Digite a expressão na notação infixa: "); // Solicita ao usuário
                                                                                                  // que insira a
                                                                                                  // expressão na forma
                                                                                                  // infixa
                        ...
                        ehValida = StackAlgorithms.ExpressaoValida(infixa, precedencia); // Verifica se a expressão é
                                                                                         // válida com base na
                                                                                         // precedência dos operadores
                        if (!ehValida)
                            System.out.println("\n                        Expressão inválida!"); // Se for inválida
                                                                                                 // imprime esta
                                                                                                 // mensagem
                    } while (!ehValida);
                    inseriValores = false;
                ...
                case 2:
                    if (infixa.isEmpty()) {
                        System.out.println("\n          Erro! Por favor insira a expressão na forma infixa."); // Se a
                                                                                                               // string
                                                                                                               // infixa
                                                                                                               // estiver
                                                                                                               // vazia
                    ...
                    System.out.println("\n                  Digite os valores das variáveis: "); // Solicita ao usuário
                                                                                                 // a entrada dos
                                                                                                 // valores para as
                                                                                                 // variáveis
                    for (int i = 0; i < estaNaExpressao.length; i++) {
                        if (estaNaExpressao[i]) {
                            System.out.printf("                  Digite o valor da variável %c: ", i + 'A'); // Recebe
                                                                                                             // os
                                                                                                             // valores
                                                                                                             // passados
                                                                                                             // pelo
                    ...
                    inseriValores = true; // Após a realização das linhas acima determina o valor desta variável como
                                          // true
                    break;
                case 3:
                    if (infixa.isEmpty()) {
                    ...
                    posfixa = StackAlgorithms.converterInfixaParaPosfixa(infixa, precedencia); // Realiza a conversão da
                                                                                               // expressão na forma
                                                                                               // infixa para a posfixa
                    System.out.println("\n+------------------------------------------------------------------+");
                    System.out.printf("| A expressão posfixa é dada por: %-33s|\n", posfixa); // Imprime a expressão
                                                                                              // convertida na forma
                                                                                              // posfixa
                    System.out.println("+------------------------------------------------------------------+");
                    gerouPosfixa = true; // Após a realização das linhas acima determina o valor desta variável como
                                         // true
                    break;
                case 4:
                    if (infixa.isEmpty()) {
                    ...
                    if (!inseriValores) {
                        System.out.println("\n          Erro! Por favor insira valores para as variáveis."); // Se
                                                                                                             // inseriValores
                                                                                                             // estiver
                                                                                                             // na
                                                                                                             // condição
                    ...
                    if (posfixa.isEmpty()) {
                        System.out.println("\nErro! Por favor selecione a opção de converter para a forma posfixa."); // Se
                                                                                                                      // a
                                                                                                                      // string
                                                                                                                      // posfixa
                                                                                                                      // estiver
                    ...
                    if (!gerouPosfixa) {
                        System.out.println("\n+------------------------------------------------------------------+");
                        System.out.println("|           Atenção! Você ainda não gerou a nova posfixa,          |"); // Se
                                                                                                                    // ja
                                                                                                                    // tiver
                                                                                                                    // uma
                                                                                                                    // expressão
                    ...
                    System.out.println("\n+------------------------------------------------------------------+");
                    System.out.println("|                       Resultado do cálculo                       |"); // Apresenta
                                                                                                                // o
                                                                                                                // resultado
                                                                                                                // do
                                                                                                                // calculo
        ...
        System.out.println("\n+------------------------------------------------------------------+");
        System.out.println("|                     Encerrando o programa...                     |"); // Imprime a
                                                                                                    // mensagem do fim
                                                                                                    // do programa
        System.out.println("+------------------------------------------------------------------+");
        input.close();
